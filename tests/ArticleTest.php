...
class PapayaModuleStandardArticleTest extends PapayaTestCase {
  ...
  /**
   * @covers PapayaModuleStandardArticle::configuration
   */
  public function testConfigurationgGetAfterSet() {
    $article = new PapayaModuleStandardArticle($this->getContentPageFixture());
    $article->configuration($configuration = $this->getMock('PapayaObjectParameters'));
    $this->assertSame($configuration, $article->configuration());
  }
  /**
   * @covers PapayaModuleStandardArticle::configuration
   */
  public function testConfigurationGetImplicitCreate() {
    $article = new PapayaModuleStandardArticle($this->getContentPageFixture());
    $this->assertInstanceOf('PapayaObjectParameters', $article->configuration());
  }
